...
export const NODES = [
  ...
  { id:"task_5", label:"Downstream Task 5\n(Finetuned scFM)", type:"DownstreamTask",
    detail:{ "Task":"Cross-model downstream task", "Model":"Single-cell FM v1 (EpiAgent)", "Input":"Genomic FM unified embedding (all modalities)", "Status":"Active" }},
  BULK_RNA_COHORT_NODE,
  BULK_ATAC_COHORT_NODE,
  SCRNA_COHORT_NODE,
  SCATAC_COHORT_NODE,
...
export const EDGES = [
  ...
  { source:"proc_bulk_rna_v1", target:"emb_genomic_all_modalities_v1", label:"EMBEDDED_BY",
    embed:{ "Scope":"all_modalities", "Included":"yes", "Embedding producer":"Genomic FM v1" }},
  { source:"proc_bulk_atac_v1", target:"emb_genomic_all_modalities_v1", label:"EMBEDDED_BY",
    embed:{ "Scope":"all_modalities", "Included":"yes", "Embedding producer":"Genomic FM v1" }},
  { source:"proc_scrna_v1", target:"emb_genomic_all_modalities_v1", label:"EMBEDDED_BY",
    embed:{ "Scope":"all_modalities", "Included":"yes", "Embedding producer":"Genomic FM v1" }},
  { source:"proc_scatac_v1", target:"emb_genomic_all_modalities_v1", label:"EMBEDDED_BY",
    embed:{ "Scope":"all_modalities", "Included":"yes", "Embedding producer":"Genomic FM v1" }},
  { source:"proc_snmultiomics_v1", target:"emb_genomic_all_modalities_v1", label:"EMBEDDED_BY",
    embed:{ "Scope":"all_modalities", "Included":"yes", "Embedding producer":"Genomic FM v1" }},
  { source:"emb_genomic_all_modalities_v1", target:"model_scfm", label:"TRAINED_ON",
    train:{ "Model version":"Single-cell FM v1 (EpiAgent)", "Training mode":"Fine-tune on external embedding", "Embedding scope":"all_modalities", "Source embedding":"emb_genomic_all_modalities_v1" }},
  ...
  { source:"model_scfm",    target:"task_5",         label:"ENABLES" },
