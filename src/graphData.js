...
import {
  CODEX_NODES,
  CODEX_HAD_MEMBER_EDGES,
  CODEX_COHORT_NODE,
  CODEX_COHORT_MEMBER_EDGES,
} from "./codexNodes";
import {
  IMC_NODES,
  IMC_HAD_MEMBER_EDGES,
  IMC_COHORT_NODE,
...
const BASE_NODES = [
  ...
  { id:"qc_codex", label:"CODEX QC\nPipeline v1.0", type:"Pipeline",
    detail:{ "Version":"v1.0", "Pipeline":"Missing in Data Track", "Path":"/nfs/turbo/umms-drjieliu1/projects/HPAP-Spatial/CODEX/export", "Metadata":"/nfs/turbo/umms-drjieliu1/projects/HPAP-Spatial/CODEX/export_metadata", "Contact":"Yiicheng Tao", "Email":"N/A", "Data Status":"Partial — Pipeline & QC/Metadata formally missing" }},
  { id:"qc_imc", label:"IMC QC\nPipeline v1.0", type:"Pipeline",
    detail:{ "Version":"v1.0", "Pipeline":"bodenmillergroup.github.io/ImcSegmentationPipeline (GitHub: BodenmillerGroup/ImcSegmentationPipeline)", "Path":"N/A", "Metadata":"Missing in Data Track", "Contact":"Yicheng Tao", "Email":"yctao@umich.edu", "Data Status":"Partial — Only pipeline submitted; data/metadata missing" }},
  ...
  { id:"proc_codex_v1", label:"CODEX Dataset\nv1.0", type:"ProcessedData",
    detail:{ "Version":"v1.0", "Path":"/nfs/turbo/umms-drjieliu1/projects/HPAP-Spatial/CODEX/export", "Metadata":"/nfs/turbo/umms-drjieliu1/projects/HPAP-Spatial/CODEX/export_metadata", "Storage":"/nfs/turbo/umms-drjieliu/usr/luosanj/FM_diabetes/data/CODEX/ ; /nfs/turbo/umms-drjieliu1/projects/HPAP-Spatial/CODEX", "Contact":"Yiicheng Tao", "Email":"N/A", "Data Status":"Partial — formal re-submission needed" }},
  { id:"proc_imc_v1", label:"IMC Dataset\nv1.0", type:"ProcessedData",
    detail:{ "Version":"v1.0", "Path":"N/A", "Pipeline":"ImcSegmentationPipeline", "Metadata":"Missing in Data Track", "Contact":"Yicheng Tao", "Email":"yctao@umich.edu", "Data Status":"Partial — data & metadata missing in current submission" }},
  ...
  { id:"dc_codex_v1", label:"Dataset Card\n(CODEX v1.0)", type:"DatasetCard",
    detail:{ "Standard":"Datasheets for Datasets (CACM 2021)", "Format":"JSON-LD", "GitHub":"github.com/mai-t1d/governance/dataset-cards/codex_v1.0.jsonld", "Author":"Yiicheng Tao", "Institution":"University of Michigan", "Consent":"Open (HPAP DUA)", "Storage":"/nfs/turbo/umms-drjieliu/usr/luosanj/FM_diabetes/data/CODEX/ ; /nfs/turbo/umms-drjieliu1/projects/HPAP-Spatial/CODEX", "Known issues":"Pipeline and QC/metadata were not formally submitted in Data Track columns", "Status":"Draft", "Updated":"2026-04-06" }},
  { id:"dc_imc_v1", label:"Dataset Card\n(IMC v1.0)", type:"DatasetCard",
    detail:{ "Standard":"Datasheets for Datasets (CACM 2021)", "Format":"JSON-LD", "GitHub":"github.com/mai-t1d/governance/dataset-cards/imc_v1.0.jsonld", "Author":"Yicheng Tao", "Institution":"University of Michigan", "Consent":"Open (HPAP DUA)", "Pipeline":"ImcSegmentationPipeline (BodenmillerGroup)", "Known issues":"Only pipeline submitted in Data Track; data and metadata paths missing", "Status":"Draft", "Updated":"2026-04-06" }},
  ...
  { id:"model_spatial", label:"Spatial FM v1\n(Kronos)", type:"Model",
    detail:{ "Version":"v1.0", "Architecture":"Spatial multi-modal transformer", "mIoU":"0.81", "Eval set":"Spatial held-out cohort", "Lighthouse":"/lighthouse/mai-t1d/models/spatial_v1.0/", "Status":"Active", "Compliance hold":"false" }},
  { id:"model_spatial_omics", label:"Spatial Omics FM v1", type:"Model",
    detail:{ "Version":"v1.0", "Architecture":"Cross-modal spatial-omics transformer", "Eval set":"scRNA + Histology held-out cohort", "Lighthouse":"/lighthouse/mai-t1d/models/spatial_omics_v1.0/", "Status":"Active", "Compliance hold":"false" }},
  ...
  { id:"mc_spatial", label:"Model Card\n(Spatial FM v1)",    type:"ModelCard",
    detail:{ "Standard":"Model Cards (FAccT 2019)", "Format":"JSON-LD", "GitHub":"github.com/mai-t1d/governance/model-cards/spatial_fm_v1.0.jsonld", "Author":"MAI-T1D team", "Linked dataset cards":"CODEX v1.0, IMC v1.0, Histology v1.0", "Intended use":"Spatial tissue representation and downstream pathology tasks", "Status":"Draft" }},
  { id:"mc_spatial_omics", label:"Model Card\n(Spatial Omics FM v1)",    type:"ModelCard",
    detail:{ "Standard":"Model Cards (FAccT 2019)", "Format":"JSON-LD", "GitHub":"github.com/mai-t1d/governance/model-cards/spatial_omics_fm_v1.0.jsonld", "Author":"MAI-T1D team", "Linked dataset cards":"scRNA-seq v1.0, Histology v1.0", "Intended use":"Joint spatial and transcriptomic representation learning", "Status":"Draft" }},
  ...
  { id:"emb_scfm_bcr_tcr_v1", label:"Single-cell FM Embedding\n(BCR + TCR v1)", type:"ProcessedData",
    detail:{ "Version":"v1.0", "Scope":"bcr_tcr", "Source model":"Single-cell FM v1 (EpiAgent)", "Included modalities":"BCR-seq, TCR-seq", "Path":"/nfs/turbo/umms-drjieliu/proj/MAI_T1D_Data/embeddings/scfm_bcr_tcr_v1/", "Note":"Embedding generated by Single-cell FM from BCR-seq + TCR-seq inputs." }},
  ...
  { id:"model_protein_ft_v2", label:"Finetuned Protein FM v2\n(on scFM BCR/TCR Embedding)", type:"FineTunedModel",
    detail:{ "Base model":"Protein FM v1", "Fine-tuned on":"emb_scfm_bcr_tcr_v1", "Training mode":"Embedding-guided fine-tuning", "Version":"v2.0-ft", "Status":"Active" }},
  ...
  { id:"task_4", label:"Downstream Task 4\n(Finetuned Protein FM)", type:"DownstreamTask",
    detail:{ "Task":"Adaptive receptor downstream task", "Model":"Finetuned Protein FM v2", "Input":"Single-cell FM BCR/TCR embedding", "Status":"Active" }},
...
const BASE_EDGES = [
  ...
  { source:"cohort_codex", target:"qc_codex", label:"USED" },
  { source:"cohort_imc", target:"qc_imc", label:"USED" },
  ...
  { source:"qc_codex", target:"proc_codex_v1", label:"GENERATED_BY" },
  { source:"qc_imc", target:"proc_imc_v1", label:"GENERATED_BY" },
  ...
  { source:"proc_codex_v1", target:"dc_codex_v1", label:"DOCUMENTED_BY" },
  { source:"proc_imc_v1", target:"dc_imc_v1", label:"DOCUMENTED_BY" },
  ...
  { source:"proc_scrna_v1", target:"model_spatial_omics", label:"TRAINED_ON",
    train:{ "Model version":"Spatial Omics FM v1.0", "Architecture":"Cross-modal spatial-omics transformer", "Modality":"scRNA-seq", "Data path":"/nfs/turbo/umms-drjieliu/usr/luosanj/FM_diabetes/data/scATAC_RNA_pankbase", "Contact":"PanKbase/Kai Liu", "Email":"N/A" }},
  { source:"proc_histology_v1", target:"model_spatial_omics", label:"TRAINED_ON",
    train:{ "Model version":"Spatial Omics FM v1.0", "Architecture":"Cross-modal spatial-omics transformer", "Modality":"Histology", "Data path":"https://wcm.box.com/s/o6nv0b0w4nityjugkh7ctp1wc7mkljwo", "Contact":"Sally Lee", "Email":"sl2767@cornell.edu" }},
  ...
  { source:"proc_bcr_seq_v1", target:"model_scfm", label:"TRAINED_ON",
    train:{ "Model version":"Single-cell FM v1 (EpiAgent)", "Architecture":"Single-cell foundation model", "Modality":"BCR-seq", "Data path":"/nfs/turbo/umms-drjieliu/usr/dongleng/02.TCR_BCR.Adil", "Contact":"Adil Mohammed", "Email":"aim4007@med.cornell.edu; am2832@cornell.edu" }},
  { source:"proc_tcr_seq_v1", target:"model_scfm", label:"TRAINED_ON",
    train:{ "Model version":"Single-cell FM v1 (EpiAgent)", "Architecture":"Single-cell foundation model", "Modality":"TCR-seq", "Data path":"/nfs/turbo/umms-drjieliu/usr/dongleng/02.TCR_BCR.Adil", "Contact":"Adil Mohammed", "Email":"aim4007@med.cornell.edu; am2832@cornell.edu" }},
  { source:"proc_codex_v1", target:"model_spatial", label:"TRAINED_ON",
    train:{ "Model version":"Spatial FM v1.0 (Kronos)", "Architecture":"Spatial multi-modal transformer", "Modality":"CODEX", "Data path":"/nfs/turbo/umms-drjieliu1/projects/HPAP-Spatial/CODEX/export", "Contact":"Yiicheng Tao", "Email":"N/A" }},
  { source:"proc_imc_v1", target:"model_spatial", label:"TRAINED_ON",
    train:{ "Model version":"Spatial FM v1.0 (Kronos)", "Architecture":"Spatial multi-modal transformer", "Modality":"IMC", "Data path":"N/A", "Contact":"Yicheng Tao", "Email":"yctao@umich.edu" }},
  { source:"proc_histology_v1", target:"model_spatial", label:"TRAINED_ON",
    train:{ "Model version":"Spatial FM v1.0 (Kronos)", "Architecture":"Spatial multi-modal transformer", "Modality":"Histology", "Data path":"https://wcm.box.com/s/o6nv0b0w4nityjugkh7ctp1wc7mkljwo", "Contact":"Sally Lee", "Email":"sl2767@cornell.edu" }},
  ...
  { source:"proc_bulk_atac_v1", target:"emb_scfm_bulk_rna_atac_v1", label:"DERIVED_FROM",
    embed:{ "Scope":"bulk_rna_bulk_atac", "Included":"yes", "Embedding producer":"Single-cell FM v1" }},
  { source:"proc_bcr_seq_v1", target:"emb_scfm_bcr_tcr_v1", label:"DERIVED_FROM",
    embed:{ "Scope":"bcr_tcr", "Included":"yes", "Embedding producer":"Single-cell FM v1" }},
  { source:"proc_tcr_seq_v1", target:"emb_scfm_bcr_tcr_v1", label:"DERIVED_FROM",
    embed:{ "Scope":"bcr_tcr", "Included":"yes", "Embedding producer":"Single-cell FM v1" }},
  ...
  { source:"emb_scfm_bcr_tcr_v1", target:"model_scfm", label:"EMBEDDED_BY",
    embed:{ "Role":"producer_model", "Scope":"bcr_tcr" }},
  ...
  { source:"model_protein_ft_v2", target:"emb_scfm_bcr_tcr_v1", label:"FINETUNED_ON",
    finetune:{ "Mode":"Embedding-guided", "Source embedding":"emb_scfm_bcr_tcr_v1" }},
  { source:"model_protein_ft_v2", target:"model_protein", label:"FINETUNED_ON",
    finetune:{ "Base model":"Protein FM v1", "Method":"Fine-tuning on Single-cell FM BCR/TCR embedding" }},
  { source:"model_scfm",    target:"mc_scfm",       label:"DOCUMENTED_BY" },
  { source:"model_genomic", target:"mc_genomic",    label:"DOCUMENTED_BY" },
  { source:"model_spatial", target:"mc_spatial",    label:"DOCUMENTED_BY" },
  { source:"model_spatial_omics", target:"mc_spatial_omics",    label:"DOCUMENTED_BY" },
  ...
  { source:"mc_spatial", target:"dc_codex_v1", label:"LINKED_TO" },
  { source:"mc_spatial", target:"dc_imc_v1", label:"LINKED_TO" },
  { source:"mc_spatial", target:"dc_histology_v1", label:"LINKED_TO" },
  { source:"mc_spatial_omics", target:"dc_scrna_v1", label:"LINKED_TO" },
  { source:"mc_spatial_omics", target:"dc_histology_v1", label:"LINKED_TO" },
  ...
  { source:"model_protein_ft_v2", target:"task_4",      label:"ENABLES" },
