...
export const EDGES = [
  ...
  { source:"model_protein", target:"emb_scfm_cite_seq_v1", label:"FINETUNED_ON",
  ...
  { source:"emb_scfm_cite_seq_v1", target:"model_protein_ft_v1", label:"GENERATED_BY",
    train:{ "Model version":"Protein FM v1.0-ft", "Training mode":"Fine-tuned on Single-cell FM CITE-seq embedding", "Embedding scope":"cite_seq_only" }},
  ...
  { source:"model_protein_ft_v1", target:"model_protein", label:"DERIVED_FROM",
